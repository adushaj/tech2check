                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                                ...
                                ?>
                                <div class="modal fade mfp-hide" id="<?php echo "modal_{$value['student_id']}_{$value['reservation_id']}"; ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <?php
                                                    ...
                                                    echo "Address: " . $info['street_line_1'] . "<br>";
                                                    echo "Phone #: " . $info['phone_number'] . "<br>";
                                                ?>
                                            </div>
