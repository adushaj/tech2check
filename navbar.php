      ...
      <div class="col-md-4">
        <ul class="list-inline user-menu pull-right">
          <?php if (isset($_SESSION['username_id'])) { ?>
            <li class="user-logout"><i class="fa fa-sign-out text-primary "></i> <a href="push/logoutpush.php" class="text-uppercase">Logout</a></li>
          <?php } else { ?>
      ...
      <ul class="nav navbar-nav" id="main-menu">
        ...
        <?php if ($_SESSION['employee_type'] == 3 || $_SESSION['employee_type'] == 2) { ?>
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="" tabindex="-1" class="menu-item">Insert Additional Function Here</a></li>
          </ul>
        <?php } ?>
        <!-- Admin Only -->
